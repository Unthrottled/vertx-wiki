...
var ArchiveResolve = /** @class */ (function () {
    function ArchiveResolve(permissons, pagesService) {
        this.permissons = permissons;
        this.pagesService = pagesService;
    }
    ArchiveResolve.prototype.resolve = function (route, state) {
        var _this = this;
        return this.permissons.canView
            .flatMap(function (canView) {
            if (canView) {
                return _this.pagesService.fetchArchivedPage(route.params["name"]);
            }
            else {
